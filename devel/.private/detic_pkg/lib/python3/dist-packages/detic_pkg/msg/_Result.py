...
"""autogenerated by genpy from detic_pkg/Result.msg. Do not edit."""
import codecs
import sys
...
class Result(genpy.Message):
  _md5sum = "8c8b9b51433524a2661ae985d6dfa2ab"
  _type = "detic_pkg/Result"
...
"""
  __slots__ = ['header','boxes','class_ids','class_names','scores','masks','xy']
  _slot_types = ['std_msgs/Header','sensor_msgs/RegionOfInterest[]','int32[]','string[]','float32[]','sensor_msgs/Image[]','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,boxes,class_ids,class_names,scores,masks,xy
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.xy))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.xy = s.unpack(str[start:end])
      return self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.xy = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
