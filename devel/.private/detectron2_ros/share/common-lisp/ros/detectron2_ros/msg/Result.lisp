...
(cl:defmethod cl:initialize-instance :after ((m <Result>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Result)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detectron2_ros-msg:<Result> is deprecated: use detectron2_ros-msg:Result instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Result>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detectron2_ros-msg:header-val is deprecated.  Use detectron2_ros-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'boxes-val :lambda-list '(m))
(cl:defmethod boxes-val ((m <Result>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detectron2_ros-msg:boxes-val is deprecated.  Use detectron2_ros-msg:boxes instead.")
  (boxes m))

(cl:ensure-generic-function 'class_ids-val :lambda-list '(m))
(cl:defmethod class_ids-val ((m <Result>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detectron2_ros-msg:class_ids-val is deprecated.  Use detectron2_ros-msg:class_ids instead.")
  (class_ids m))

(cl:ensure-generic-function 'class_names-val :lambda-list '(m))
(cl:defmethod class_names-val ((m <Result>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detectron2_ros-msg:class_names-val is deprecated.  Use detectron2_ros-msg:class_names instead.")
  (class_names m))

(cl:ensure-generic-function 'scores-val :lambda-list '(m))
(cl:defmethod scores-val ((m <Result>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detectron2_ros-msg:scores-val is deprecated.  Use detectron2_ros-msg:scores instead.")
  (scores m))

(cl:ensure-generic-function 'masks-val :lambda-list '(m))
(cl:defmethod masks-val ((m <Result>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detectron2_ros-msg:masks-val is deprecated.  Use detectron2_ros-msg:masks instead.")
  (masks m))
