...
"""autogenerated by genpy from tmc_vision_msgs/DetectionArray.msg. Do not edit."""
import codecs
import sys
...
class DetectionArray(genpy.Message):
  _md5sum = "81ce6d024652b585c906e49f2c2eb09c"
  _type = "tmc_vision_msgs/DetectionArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','tmc_vision_msgs/Detection[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = tmc_vision_msgs.msg.Detection()
        _v2 = val1.label
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        ...
        (_v2.confidence,) = _get_struct_d().unpack(str[start:end])
        _x = val1
        start = end
        end += 32
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v4.confidence,) = _get_struct_d().unpack(str[start:end])
        _x = val1
        start = end
        end += 32
        (_x.x, _x.y, _x.width, _x.height,) = _get_struct_4d().unpack(str[start:end])
