...
class Detectron2node(object):
    def __init__(self):
        ...
        register_coco_instances("ycb_v_obj_02", {}, "/home/demulab/dspl_ws/include/ycb_video_1m/instances_02.json", "")
        ##############################
        self.cfg.DATASETS.TRAIN = ("ycb_v_obj_02",)
        ...
        MetadataCatalog.get("takenoko").set(thing_classes = ["takenoko", "cola", "pocky", "noodle", "tea"])
        ...
        #self._class_names = MetadataCatalog.get("ycb_v").get("thing_classes", None)
        ...
        while not rospy.is_shutdown():
            ...
            if img_msg is not None:
                ...
                if self._visualization:
                    v = Visualizer(np_image[:, :, ::-1], MetadataCatalog.get("takenoko"), scale=1.2)
